...
Predictions are calculated for each mother age from 1 to 8 keeping the rodent index equal to median value of the variable. Random effects are ignored by using the argument type = 'fixed'.
...
(pw <- ggpredict(w1, terms="mother_age [all]",
                 ...
                 condition = c(rodent_index = 4))) 
                   # median value for rodent_index = 4
