...
# Expcted number of surviving pups in captivity

The expected number of surviving offspring in captivity ($\Lambda_a$), depending on mother age ($a$), can be computed from multiplying the predicted breeding probability ($B_a$), litter size ($L_a$), and offspring survival ($S_a$) for each mother age.
